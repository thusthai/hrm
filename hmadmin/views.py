...
from hmadmin.forms import FormUser ,formAddUserApp,formEditUserApp
from hmdb.models import TblDepartment,TblUserAuth,TblAllowApp
...
def adminhome(request):
    ...
    return render(request,'hm-home-setting.html',context)
